...
def generar_grafico_y_guardar_imagen(archivos_csv, tamanos, carpeta_destino, nombre_imagen):
    ...
    for archivo in archivos_csv:
        ...
        for tamano in tamanos:
            ...
            plt.scatter(data_tamano['Procesadores'], data_tamano['Tiempo Promedio'], label=f'{obtener_texto_desde_nombre(archivo)} - Tamaño {tamano}')
...
archivos_csv = ['OpenMP_Columnas_Condor.csv', 'OpenMP_Columnas_Ubuntu.csv', 'OpenMP_Columnas_Windows.csv']

# Tamaños a considerar en la gráfica
tamanos_grafica = [4000]

# Generar y guardar la gráfica comparativa
nombre_imagen = 'grafica_comparativa_columnas_4000.png'
